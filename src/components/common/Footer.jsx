...
// Images
import EduProLogo from "../../assets/Logo/Logo-Full-Light.png"; // Make sure to replace this with your actual logo file
...
const Plans = ["Premium Memberships", "For Students", "Corporate Plans"];
        ...
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              <img src={EduProLogo} alt="EDU-PRO Logo" className="object-contain" />
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row">
            <div className="flex">
              ...
              <Link to='https://github.com/Abhinay0505' target="_blank" rel="noopener noreferrer" className="text-white hover:underline mr-1">
                ABHINAY NETTIKOPPULA
              </Link>
            </div>
            <span> © {2025} EDU-PRO</span>
          </div>

          <div className="flex items-center">
            <a href="https://www.linkedin.com/in/nettikoppula-abhinay-029b64281/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://github.com/Abhinay0505" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
          </div>
        </div>
